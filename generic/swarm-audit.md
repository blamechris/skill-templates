...
{{CUSTOMIZE: Add domain-specific agents to the extended roster. Example: "Expo Expert" for mobile/Expo projects, "Tunneler" for networking-heavy projects. Each needs Nickname, Lens, and When to Include.}}
...
{{CUSTOMIZE: Add project-specific grading criteria. Example: "For mobile projects, Operator should weight touch target sizes and offline behavior. For API projects, Guardian should weight rate limiting and auth bypass."}}
